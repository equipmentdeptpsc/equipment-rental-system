...
type RentalBookingView = "list" | "calendar" | "agenda";
...
function RentalCalendarAgendaView({ mode, filters }: { mode: Exclude<RentalBookingView, "list">; filters: CanonicalBookingSearchInput }) {
  const { readRepositories } = useApplicationDependenciesCompatibility();
