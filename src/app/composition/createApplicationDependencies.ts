...
import { createSupabaseOperationalCommands, createSupabaseRentalCancellationCommands, createSupabaseRentalReturnCommands } from "@/integrations/supabase/SupabaseOperationalCommandRepository";
...
export function createApplicationDependencies(configuration:ApplicationRuntimeConfiguration=readApplicationRuntimeConfiguration(),overrides:ApplicationDependencyOverrides={}):ApplicationDependencies{
  ...
  const rentalCancellationCommands=configuration.remoteOperationalWritesEnabled||configuration.remoteRentalCancelEnabled===true?createSupabaseRentalCancellationCommands(client):undefined;
