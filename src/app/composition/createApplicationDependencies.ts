...
export interface ApplicationRuntimeConfiguration { persistenceMode?:string;equipmentStatusSource?:string;supabaseUrl?:string;supabasePublishableKey?:string;remoteOperationalWritesEnabled?:boolean;remoteRentalCreateEnabled?:boolean;remoteAssignmentCreateEnabled?:boolean;remoteAssignmentCancelEnabled?:boolean;operationalReadTransport?:string }
