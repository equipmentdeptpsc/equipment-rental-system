...
export interface ApplicationRuntimeConfiguration { persistenceMode?:string;equipmentStatusSource?:string;supabaseUrl?:string;supabasePublishableKey?:string;remoteOperationalWritesEnabled?:boolean;remoteRentalCreateEnabled?:boolean;remoteRentalCommercialTermsEnabled?:boolean;remoteRentalApprovalEnabled?:boolean;remoteRentalReserveEnabled?:boolean;remoteRentalReleaseEnabled?:boolean;remoteRentalActivateEnabled?:boolean;remoteAssignmentCreateEnabled?:boolean;remoteAssignmentCancelEnabled?:boolean;remoteProjectCustomerLinkEnabled?:boolean;operationalReadTransport?:string }
...
export function readApplicationRuntimeConfiguration():ApplicationRuntimeConfiguration{
  ...
  return{persistenceMode:mode,equipmentStatusSource:value.source,supabaseUrl:value.supabaseUrl,supabasePublishableKey:value.supabasePublishableKey,remoteOperationalWritesEnabled:import.meta.env.VITE_REMOTE_OPERATIONAL_WRITES_ENABLED==="true",remoteRentalCreateEnabled:import.meta.env.VITE_REMOTE_RENTAL_CREATE_ENABLED==="true",remoteRentalCommercialTermsEnabled:import.meta.env.VITE_REMOTE_RENTAL_COMMERCIAL_TERMS_ENABLED==="true",remoteRentalApprovalEnabled:import.meta.env.VITE_REMOTE_RENTAL_APPROVAL_ENABLED==="true",remoteRentalReserveEnabled:import.meta.env.VITE_REMOTE_RENTAL_RESERVE_ENABLED==="true",remoteRentalReleaseEnabled:import.meta.env.VITE_REMOTE_RENTAL_RELEASE_ENABLED==="true",remoteRentalActivateEnabled:import.meta.env.VITE_REMOTE_RENTAL_ACTIVATE_ENABLED==="true",remoteAssignmentCreateEnabled:import.meta.env.VITE_REMOTE_ASSIGNMENT_CREATE_ENABLED==="true",remoteAssignmentCancelEnabled:import.meta.env.VITE_REMOTE_ASSIGNMENT_CANCEL_ENABLED==="true",remoteProjectCustomerLinkEnabled:import.meta.env.VITE_REMOTE_PROJECT_CUSTOMER_LINK_ENABLED==="true",operationalReadTransport:import.meta.env.VITE_OPERATIONAL_READ_TRANSPORT};
}
